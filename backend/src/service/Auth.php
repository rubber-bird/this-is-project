...
class Auth {
    ...
    public function signUp(
        ...
        if ($this->userRepository->findByEmail($email)->hasValue()) {
            return Result::fail(
                409,
                'conflict',
        ...
        $account = $this->accountRepo->save(
            new Account(
                id: null,
                name: "$givenName's account"
            )
        );
    ...
    public function signIn(
        ...
        $maybe = $this->userRepository->findByEmail($email);
